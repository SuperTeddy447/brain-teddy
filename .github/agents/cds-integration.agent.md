...
Record actual results in test/performance/AI usage documents, maintain demo script and verify the submitted artifact before 18:00 Thailand time. Keep `docs/legacy-modernization.md` aligned with implemented/fallback/blocked/future boundaries. Do not claim tests, AAD or DB2 integration that did not run. Do not commit, push or submit automatically without the teammate's current request.
