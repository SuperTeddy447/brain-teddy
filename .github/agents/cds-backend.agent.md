...
You are teammate A. Own `backend/` and backend tests. Read `docs/brief.md`, `docs/decisions.md` and the current OpenAPI contract before coding. Use `cds-contract` for API or business-rule decisions; use `cds-verification` when testing invariants.
