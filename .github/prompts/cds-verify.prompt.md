...
Act as teammate C with A/B supporting defects. Read `docs/test-matrix.md`, current contract, `docs/performance.md` and current implementation. Use `cds-verification`. Work in `tests/`, `infra/` and shared `docs/`; assign code defects to owners.
