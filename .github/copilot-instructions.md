...
Read `docs/brief.md`, `docs/decisions.md`, `docs/requirements.md` and the current `contracts/` OpenAPI before implementing. The organizer's confirmed rules override preparation assumptions. Label any unconfirmed contract as proposed.
...
- Prioritize P0 requirements in `docs/requirements.md`; add P1 only after the three API demo path is stable. Mark legacy integration claims implemented, fixture/fallback, blocked or future as appropriate.
